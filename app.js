...
// Делегирование событий для раскрытия меню
document.addEventListener('click', (event) => {
  if (event.target.classList.contains('dropdown-toggle')) {
    ...
    // Закрываем все открытые меню при клике вне
...
const card = [
 ...
 text1:"Снятие ломки",
 price1: '6 500',
 text2:"Наркологическая помощь",
 price2: '6 000',
 text3:"Детоксикация от наркотиков",
 price3: '6 000',
  },
  {
 ...
 text:"Вывод из запоя",
 price: '3 500',
 text1:"Капельница от похмелья",
 price1: '3 500',
 text2:"Нарколог на дом",
 price2: '3 500',
 text3:"Консультация нарколога",
 price3: '2 000',
  },
]
...
function moveCarousel(direction) {
    ...
    const imageWidth = images[0].clientWidth + 20; // Ширина изображения + отступы
